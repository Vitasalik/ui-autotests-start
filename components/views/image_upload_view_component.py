...
class ImageUploadViewComponent(BaseComponent):
    def __init__(self, page: Page, identifier: str):
        ...
        self.image_upload_image_info_icon = page.get_by_test_id(f"{identifier}-image-upload-widget-info-icon")
    ...
    def check_visible(self, is_image_uploaded: bool = False):
        expect(self.image_upload_image_info_icon).to_be_visible()
