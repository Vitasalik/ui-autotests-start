...
class CreateCourseFormComponent(BaseComponent):
    def __init__(self, page):
        ...
        self.estimate_time_input = page.get_by_test_id("create-course-form-estimated-time-input").locator("input")
    ...
    def check_visible(self, title: str, estimated_time: str, description: str, max_score: str, min_score: str):
        ...
        expect(self.estimate_time_input).to_have_text(estimated_time)

        expect(self.description_input).to_be_visible()
        expect(self.description_input).to_have_text(description)
