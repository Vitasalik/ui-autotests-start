...
class CourseViewComponent(BaseComponent):
    def __init__(self, page: Page):
        ...
        self.menu = CourseViewMenuComponent(self.page)
        ...
        self.estimate_time = page.get_by_test_id("course-estimated-time-info-row-view-text")

    def check_visible(self, index: int, title: str, max_score: str, min_score: str,
                                  estimate_time: str):
        ...
        expect(self.estimate_time.nth(index)).to_be_visible()
        expect(self.estimate_time.nth(index)).to_have_text(f"Estimated time: {estimate_time}")