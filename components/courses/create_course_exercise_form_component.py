...
class CreateCourseExerciseFormComponent(BaseComponent):
    def __init__(self, page: Page):
        ...
        self.description_input = Input(page, f"create-course-exercise-form-description-0-input", "Description")
    ...
    def check_visible(self, index: int, title: str, description: str):
        ...
        self.subtitle.check_have_text(f"#{index} Exercise", index=index)
